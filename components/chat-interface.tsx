                ...
                <div className="container mx-auto px-4 py-4 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-muted-foreground">Multilingual Education Assistant</p>
                        </div>
                    </div>
                ...
                <div className="container mx-auto px-4 py-6 max-w-4xl">
                    {messages.length === 0 && !isLoading && (
                        <div className="flex flex-col items-center justify-center h-full text-center py-12">
                            ...
                            <h2 className="text-2xl font-bold mb-2">Welcome to Vidya Vaani!</h2>
                            <p className="text-muted-foreground max-w-md">
                                Ask me anything about admissions, courses, fees, or college policies.
                                I can help you in English, Hindi, Marathi, or Marwari.
                            </p>
                        </div>
                    )}
