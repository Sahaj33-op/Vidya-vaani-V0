...
export function loadMessagesFromLocalStorage(): Message[] {
    try {
        ...
        console.error('[Chat] Failed to load from localStorage:', error)
        return []
    }
}
...
export function saveLanguagePreference(language: string): void {
    try {
        ...
        console.error('[Chat] Failed to save language preference:', error)
    }
}
...
export function loadLanguagePreference(): string {
    try {
        ...
        console.error('[Chat] Failed to load language preference:', error)
        return 'en'
    }
}
