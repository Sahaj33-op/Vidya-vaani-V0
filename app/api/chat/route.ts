...
export async function POST(request: NextRequest) {
    try {
        ...
        if (process.env.NEXT_PUBLIC_DEV_MODE === 'true') {
            console.log('[Chat API] Dev mode - returning mock response')
            console.log('[Chat API] Message:', message, 'Language:', language)
        ...
        console.log('[Chat API] Forwarding to backend:', backendUrl)
