...
export async function POST(request: NextRequest) {
  try {
    ...
    return NextResponse.json(
      {
        answer:
          "I'm experiencing technical difficulties with document search. Please try again later.",
        sources: [],
        confidence: 0,
      },
      { status: 500 },
...
Scholarships are available with up to 50% fee waiver for merit students.`,
      sources: [
        "fee_structure:section_1",
        "fee_structure:section_2",
        "general_faq:fees",
      ],
      confidence: 0.92,
      retrieved_chunks: [
...
• Postgraduate: Minimum 55% in graduation`,
      sources: [
        "admission_guide:section_1",
        "admission_guide:section_2",
        "general_faq:admission",
      ],
      confidence: 0.95,
      retrieved_chunks: [
